            ...
            <div className={styles.header}>
                <div className={styles.mobileView}>
                    <ul>
                        ...
                        <li><a href="https://www.paypal.com/paypalme/kailashw" target="_blank"> <img src='/support.png' alt="support-icon" width="32" height="32" /> </a></li>
                ...
                <div className={styles.webView}>
                    <ul>
                        ...
                        <li><a href="https://www.paypal.com/paypalme/kailashw" target="_blank"> Support on Paypal </a></li>
